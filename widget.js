...
#nba-calendar .nba-list-body { flex: 1; min-width: 0; margin: 0 !important; padding: 0 !important; display: grid !important; row-gap: 4px !important; align-content: start !important; }
...
#nba-calendar:not(#nba-x) .nba-list-body { margin: 0 !important; padding: 0 !important; display: grid !important; row-gap: 4px !important; align-content: start !important; }
    ...
    const html = Object.keys(groups).sort().map(date => {
      ...
      const rows = groups[date].map(e => {
        ...
        return '<a href="' + h(e.url) + '" target="_blank" rel="noopener"'
          ...
          + img
          + '<div class="nba-list-body" style="display:grid!important;row-gap:4px!important;align-content:start!important;margin:0!important;padding:0!important;flex:1;min-width:0">'
