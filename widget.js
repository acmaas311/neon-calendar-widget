...
#nba-calendar .nba-tt-desc     {
  font-size: 14px; color: #444; line-height: 1.4 !important;
...
#nba-calendar:not(#nba-x) .nba-list-tags { margin: 0 !important; padding: 0 !important; }
  ...
  function ttHTML(e, flip, showImg = true) {
    ...
    const desc = shortDesc
      ? '<div style="font-size:14px!important;color:#444!important;line-height:1.45!important;border-top:1px solid #e8f3ec!important;padding:4px 0 0!important;margin:5px 0 0!important;overflow:hidden!important">' + h(shortDesc) + '</div>'
      : '';
